...
#---------------------------
# Instantiating matmul_partition_1
#---------------------------
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /matmul_partition_1/s_axi_control] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /matmul_partition_1/ap_clk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /matmul_partition_1/ap_rst_n] \

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /matmul_1/m_axi_gmem] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /matmul_partition_1/m_axi_gmem] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]
