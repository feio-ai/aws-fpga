...
# Compute Unit Stalls
#
set computeUnits { matmul_partition_1 matmul_1 }
...
set readBusySignals { /emu_wrapper/emu_i/matmul_partition_1/m_axi_gmem.readActive /emu_wrapper/emu_i/matmul_1/m_axi_gmem.readActive }
set writeBusySignals { /emu_wrapper/emu_i/matmul_partition_1/m_axi_gmem.writeActive /emu_wrapper/emu_i/matmul_1/m_axi_gmem.writeActive }
