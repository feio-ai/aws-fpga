...
################################################################
# This is a generated script based on design: bd_ffc7
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./cl/cl.srcs/sources_1/bd/cl/ip/cl_HIP_0/bd_2
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.S_ARUSER_WIDTH {114} \
   CONFIG.S_AWUSER_WIDTH {114} \
   CONFIG.S_BUSER_WIDTH {114} \
   CONFIG.S_PROTOCOL {AXI4} \
   CONFIG.S_RUSER_WIDTH {14} \
   CONFIG.S_WUSER_WIDTH {14} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins S00_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_ARUSER_WIDTH {114} \
   CONFIG.SC_AWUSER_WIDTH {114} \
   CONFIG.SC_BUSER_WIDTH {114} \
