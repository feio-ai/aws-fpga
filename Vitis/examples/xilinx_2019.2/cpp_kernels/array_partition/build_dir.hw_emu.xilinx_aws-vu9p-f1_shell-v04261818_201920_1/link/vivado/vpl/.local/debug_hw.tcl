  ...
  proc insert_chipscope {hw_platform_info debug_profile_info} {
    ...
    foreach cell $system_ila_cells {
      ...
      foreach pin $pins {
        ...
        set_property HDL_ATTRIBUTE.DPA_MONITOR_IP            true [get_bd_cells $cell]
        set_property HDL_ATTRIBUTE.DPA_MONITOR_IP_FULLNAME   $pin [get_bd_cells $cell]
        set_property HDL_ATTRIBUTE.DPA_MONITOR_IP_PROPERTIES 0    [get_bd_cells $cell]
      }
    }
  ...
  proc apply_user_ila_properties {} {
    if { [info exists ::env(VITIS_CHIPSCOPE_TCL)] } {
      ...
      if { [file exists $ila_script] } {
        puts "--- DEBUG: sourcing VITIS_CHIPSCOPE_TCL script: $ila_script"
        source $ila_script
      }
    }
  }
