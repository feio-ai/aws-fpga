...
proc create_hier_cell_slr1 { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M01_AXI] [get_bd_intf_pins interconnect_axilite_user_1/M01_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M02_AXI] [get_bd_intf_pins interconnect_axilite_user_1/M02_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M03_AXI] [get_bd_intf_pins interconnect_axilite_user_1/M03_AXI]
  ...
  connect_bd_net -net ext_reset_in_1_1 [get_bd_pins dma_pcie_arst] [get_bd_pins interconnect_axilite_user_1/ARESETN] [get_bd_pins interconnect_axilite_user_1/M00_ARESETN] [get_bd_pins interconnect_axilite_user_1/M03_ARESETN] [get_bd_pins interconnect_axilite_user_1/S00_ARESETN]
  connect_bd_net -net ext_reset_in_2_1 [get_bd_pins ext_reset_in1] [get_bd_pins psr_kernel2_clk_1/ext_reset_in]
  connect_bd_net -net psr_kernel_clk_1_interconnect_aresetn [get_bd_pins interconnect_axilite_user_1/M01_ARESETN] [get_bd_pins interconnect_axilite_user_1/M02_ARESETN] [get_bd_pins psr_kernel_clk_1/interconnect_aresetn]
  connect_bd_net -net psr_kernel_clk_1_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins psr_kernel_clk_1/peripheral_aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins slowest_sync_clk] [get_bd_pins interconnect_axilite_user_1/M01_ACLK] [get_bd_pins interconnect_axilite_user_1/M02_ACLK] [get_bd_pins psr_kernel_clk_1/slowest_sync_clk]
  connect_bd_net -net slowest_sync_clk_1_1 [get_bd_pins dma_pcie_aclk] [get_bd_pins interconnect_axilite_user_1/ACLK] [get_bd_pins interconnect_axilite_user_1/M00_ACLK] [get_bd_pins interconnect_axilite_user_1/M03_ACLK] [get_bd_pins interconnect_axilite_user_1/S00_ACLK]
...
proc create_hier_cell_slr0 { parentCell nameHier } {
  ...
  connect_bd_net -net ext_reset_in_1_1 [get_bd_pins dma_pcie_arst] [get_bd_pins interconnect_axilite_user_0/ARESETN] [get_bd_pins interconnect_axilite_user_0/M00_ARESETN] [get_bd_pins interconnect_axilite_user_0/S00_ARESETN] [get_bd_pins to_delete_kernel_ctrl_0/s_axi_aresetn]
  connect_bd_net -net ext_reset_in_2_1 [get_bd_pins ext_reset_in1] [get_bd_pins psr_kernel2_clk_0/ext_reset_in]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins slowest_sync_clk] [get_bd_pins psr_kernel_clk_0/slowest_sync_clk]
  connect_bd_net -net slowest_sync_clk_1_1 [get_bd_pins dma_pcie_aclk] [get_bd_pins interconnect_axilite_user_0/ACLK] [get_bd_pins interconnect_axilite_user_0/M00_ACLK] [get_bd_pins interconnect_axilite_user_0/S00_ACLK] [get_bd_pins to_delete_kernel_ctrl_0/s_axi_aclk]
...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_System_DPA() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:aximm_rtl:1.0 MON_S_AXI1
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/matmul_1} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {matmul_1:m_axi_gmem-DDR[1]} \
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/matmul_1/m_axi_gmem-DDR[1]} [get_bd_cells /System_DPA/dpa_mon1]

  # Create instance: dpa_mon2, and set properties
  set dpa_mon2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_accel_monitor:1.0 dpa_mon2 ]
  set_property -dict [ list \
   CONFIG.COUNT_WIDTH {64} \
   CONFIG.ENABLE_TRACE {1} \
   CONFIG.EN_AXI_LITE {1} \
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/matmul_partition_1} [get_bd_cells /System_DPA/dpa_mon2]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {matmul_partition_1:m_axi_gmem-DDR[1]} \
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/matmul_partition_1/m_axi_gmem-DDR[1]} [get_bd_cells /System_DPA/dpa_mon3]
  ...
  connect_bd_intf_net -intf_net dpa_mon2_TRACE_OUT [get_bd_intf_pins dpa_hub/TRACE_IN_3] [get_bd_intf_pins dpa_mon2/TRACE_OUT]
  connect_bd_intf_net -intf_net dpa_mon3_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_4] [get_bd_intf_pins dpa_mon3/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon3_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_5] [get_bd_intf_pins dpa_mon3/TRACE_OUT_1]
  connect_bd_intf_net -intf_net matmul_1_m_axi_gmem [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  connect_bd_intf_net -intf_net matmul_partition_1_m_axi_gmem [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon3/MON_M_AXI]
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon1/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon0/S_AXI_MON]
  connect_bd_intf_net -intf_net slr1_M02_AXI [get_bd_intf_pins MON_S_AXI1] [get_bd_intf_pins dpa_mon3/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M02_AXI] [get_bd_intf_pins MON_S_AXI1] [get_bd_intf_pins dpa_mon2/S_AXI_MON]
  ...
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins trace_clk] [get_bd_pins dpa_ctrl_interconnect/M00_ACLK] [get_bd_pins dpa_ctrl_interconnect/M01_ACLK] [get_bd_pins dpa_ctrl_interconnect/M02_ACLK] [get_bd_pins dpa_ctrl_interconnect/M03_ACLK] [get_bd_pins dpa_ctrl_interconnect/M04_ACLK] [get_bd_pins dpa_ctrl_interconnect/M05_ACLK] [get_bd_pins dpa_hub/axilite_clk] [get_bd_pins dpa_hub/trace_clk] [get_bd_pins dpa_mon0/mon_clk] [get_bd_pins dpa_mon0/trace_clk] [get_bd_pins dpa_mon1/mon_clk] [get_bd_pins dpa_mon1/trace_clk] [get_bd_pins dpa_mon2/mon_clk] [get_bd_pins dpa_mon2/trace_clk] [get_bd_pins dpa_mon3/mon_clk] [get_bd_pins dpa_mon3/trace_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins trace_rst] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M02_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M03_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M04_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M05_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst] [get_bd_pins dpa_mon1/mon_resetn] [get_bd_pins dpa_mon1/trace_rst] [get_bd_pins dpa_mon2/mon_resetn] [get_bd_pins dpa_mon2/trace_rst] [get_bd_pins dpa_mon3/mon_resetn] [get_bd_pins dpa_mon3/trace_rst]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: matmul_1, and set properties
  set matmul_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matmul:1.0 matmul_1 ]

  # Create instance: matmul_partition_1, and set properties
  set matmul_partition_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matmul_partition:1.0 matmul_partition_1 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins System_DPA/S00_AXI] [get_bd_intf_pins slr1/M03_AXI]
  ...
  connect_bd_intf_net -intf_net matmul_1_m_axi_gmem [get_bd_intf_pins matmul_1/m_axi_gmem] [get_bd_intf_pins memory_subsystem/S04_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets matmul_1_m_axi_gmem] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net matmul_partition_1_m_axi_gmem [get_bd_intf_pins matmul_partition_1/m_axi_gmem] [get_bd_intf_pins memory_subsystem/S05_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets matmul_partition_1_m_axi_gmem] [get_bd_intf_pins System_DPA/MON_M_AXI1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  ...
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins matmul_1/s_axi_control] [get_bd_intf_pins slr1/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr1/M01_AXI]
  connect_bd_intf_net -intf_net slr1_M02_AXI [get_bd_intf_pins matmul_partition_1/s_axi_control] [get_bd_intf_pins slr1/M02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M02_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI1] [get_bd_intf_pins slr1/M02_AXI]
  ...
  connect_bd_net -net matmul_1_interrupt [get_bd_pins interrupt_concat/In0] [get_bd_pins matmul_1/interrupt]
  connect_bd_net -net matmul_partition_1_interrupt [get_bd_pins interrupt_concat/In1] [get_bd_pins matmul_partition_1/interrupt]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins System_DPA/trace_clk] [get_bd_pins kernel_clk/clk] [get_bd_pins matmul_1/ap_clk] [get_bd_pins matmul_partition_1/ap_clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins slr0/slowest_sync_clk] [get_bd_pins slr1/slowest_sync_clk] [get_bd_pins slr2/slowest_sync_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins matmul_1/ap_rst_n] [get_bd_pins matmul_partition_1/ap_rst_n] [get_bd_pins slr1/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/M01_AXI_MEM00] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces memory_subsystem/M02_AXI] [get_bd_addr_segs sim_ddr_2/C0_DDR_SAXI/C0_DDR_SAXI_mem] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces memory_subsystem/M03_AXI] [get_bd_addr_segs sim_ddr_3/C0_DDR_SAXI/C0_DDR_SAXI_mem] -force
  assign_bd_address -offset 0x1C000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs slr0/to_delete_kernel_ctrl_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x1D000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_hub/S_AXIFIFO/Reg] -force
  assign_bd_address -offset 0x1D010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_hub/S_AXIHUB/Reg] -force
  ...
  assign_bd_address -offset 0x1D020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon0/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon1/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon2/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon3/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs matmul_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x1D070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs matmul_partition_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces matmul_partition_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM02]
