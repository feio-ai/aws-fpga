...
set dpa_dict [list \
              [get_bd_intf_pins /matmul_1/m_axi_gmem]  {TYPE data DETAIL all CLK_SRC /matmul_1/ap_clk RST_SRC /slr1/peripheral_aresetn MON_ID {{matmul_1:m_axi_gmem-DDR[1]}} MEMORY {{DDR[1]}}} \
              [get_bd_intf_pins /matmul_partition_1/m_axi_gmem]  {TYPE data DETAIL all CLK_SRC /matmul_partition_1/ap_clk RST_SRC /slr1/peripheral_aresetn MON_ID {{matmul_partition_1:m_axi_gmem-DDR[1]}} MEMORY {{DDR[1]}}} \
              [get_bd_cells matmul_1]  {TYPE exec DETAIL all CLK_SRC /matmul_1/ap_clk RST_SRC /slr1/peripheral_aresetn} \
              [get_bd_cells matmul_partition_1]  {TYPE exec DETAIL all CLK_SRC /matmul_partition_1/ap_clk RST_SRC /slr1/peripheral_aresetn} \
             ]
...
set_param bd.debug_profile.script /home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2019.2/cpp_kernels/array_partition/build_dir.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_1/link/vivado/vpl/.local/debug_profile_automation.tcl
