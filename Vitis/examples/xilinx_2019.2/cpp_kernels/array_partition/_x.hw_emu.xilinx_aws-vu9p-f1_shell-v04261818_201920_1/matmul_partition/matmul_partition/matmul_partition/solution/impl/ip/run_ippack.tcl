...
set Library     "hls"
set IPName      "matmul_partition"
set Version     "1.0"
set DisplayName "Matmul_partition"
set Revision    "2004291905"
set Description "An IP generated by Vivado HLS"
set Device      "virtexuplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set target_part "xcvu9p-flgb2104-2-i"
set target_lang "verilog"
set has_xpm_memory "0"
set sdx_kernel_name "matmul_partition"
set sdx_kernel_type "hls"
set sdx_kernel_files {/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2019.2/cpp_kernels/array_partition/src/matmul_partition.cpp}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2019.2/cpp_kernels/array_partition/_x.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_1/matmul_partition/matmul_partition/matmul_partition/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {matmul_partition_matmul_partition_mul_32s_32s_32_4_1
...
## Variables
set Top "matmul_partition_matmul_partition"
set TopNoPrefix "matmul_partition"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 in1_1 W 0x0 "Data signal of in1" {{0 32 in1 W 0 "Bit 31 to 0 Data signal of in1"}}} {0x14 in1_2 W 0x0 "Data signal of in1" {{0 32 in1 W 0 "Bit 63 to 32 Data signal of in1"}}} {0x1c in2_1 W 0x0 "Data signal of in2" {{0 32 in2 W 0 "Bit 31 to 0 Data signal of in2"}}} {0x20 in2_2 W 0x0 "Data signal of in2" {{0 32 in2 W 0 "Bit 63 to 32 Data signal of in2"}}} {0x28 out_r_1 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 Data signal of out_r"}}} {0x2c out_r_2 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 63 to 32 Data signal of out_r"}}} {0x34 size W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 31 to 0 Data signal of size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 1064 II x}
