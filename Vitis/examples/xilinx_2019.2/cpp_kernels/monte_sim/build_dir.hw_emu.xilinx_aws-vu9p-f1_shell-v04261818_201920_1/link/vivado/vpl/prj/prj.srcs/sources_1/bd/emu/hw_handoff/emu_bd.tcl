...
proc create_hier_cell_embedded_schedular { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_embedded_schedular() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_clk_reset_wizard { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_clk_reset_wizard() - Empty argument(s)!"}
     return
  }
