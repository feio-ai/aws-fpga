...
proc create_hier_cell_interconnect { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.ADVANCED_PROPERTIES {__view__ {functional {S00_Buffer {R_SIZE 512 W_SIZE 512}} timing {M01_Buffer {AR_SLR_PIPE 2 AW_SLR_PIPE 2 R_SLR_PIPE 2 W_SLR_PIPE 2 B_SLR_PIPE 2} M03_Buffer {AR_SLR_PIPE 2 AW_SLR_PIPE 2 R_SLR_PIPE 2 W_SLR_PIPE 2 B_SLR_PIPE 2} M04_Buffer {AR_SLR_PIPE 2 AW_SLR_PIPE 2 R_SLR_PIPE 2 W_SLR_PIPE 2 B_SLR_PIPE 2} M06_Buffer {AR_SLR_PIPE 2 AW_SLR_PIPE 2 R_SLR_PIPE 2 W_SLR_PIPE 2 B_SLR_PIPE 2}}}} \
   CONFIG.NUM_MI {7} \
   CONFIG.NUM_SI {1} \
  ...
  connect_bd_net -net psr_aclk_SLR0_interconnect_aresetn [get_bd_pins aresetn2] [get_bd_pins interconnect_ddr4_mem03/aresetn] [get_bd_pins interconnect_plram_mem02/aresetn]
  connect_bd_net -net psr_aclk_SLR1_interconnect_aresetn [get_bd_pins aresetn] [get_bd_pins interconnect_ddr4_mem00/aresetn] [get_bd_pins interconnect_ddr4_mem02/aresetn] [get_bd_pins interconnect_plram_mem01/aresetn] [get_bd_pins interconnect_s00_axi/aresetn] [get_bd_pins vip_s00_axi/aresetn]
  connect_bd_net -net psr_aclk_SLR2_interconnect_aresetn [get_bd_pins aresetn1] [get_bd_pins interconnect_ddr4_mem01/aresetn] [get_bd_pins interconnect_plram_mem00/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net psr_aclk_SLR0_interconnect_aresetn [get_bd_pins interconnect/aresetn2] [get_bd_pins memory/aresetn2] [get_bd_pins reset/interconnect_aresetn]
  connect_bd_net -net psr_aclk_SLR1_interconnect_aresetn [get_bd_pins interconnect/aresetn] [get_bd_pins memory/aresetn1] [get_bd_pins reset/interconnect_aresetn1]
  connect_bd_net -net psr_aclk_SLR2_interconnect_aresetn [get_bd_pins interconnect/aresetn1] [get_bd_pins memory/aresetn] [get_bd_pins reset/interconnect_aresetn2]
